            ...
            _createClass(Iti, [
                ...
                },
                {
                    ...
                    value: function _updateDialCode(newDialCodeBare, hasSelectedListItem) {
                        ...
                        } else if (this.options.nationalMode || this.options.separateDialCode) // don't do anything
                        return;
                        else {
                            // nationalMode is disabled
                            if (inputVal) // there is an existing value with no dial code: prefix the new dial code
                            newNumber = newDialCode + inputVal;
                            else if (hasSelectedListItem || !this.options.autoHideDialCode) // no existing value and either they've just selected a list item, or autoHideDialCode is
...
//# sourceMappingURL=index.b1bae485.js.map
